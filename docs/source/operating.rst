[tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96] container is NOT running**.

.. tip::
   You must have your [tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   reshmareddy09/tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96-amd64 (https://hub.docker.com/r/reshmareddy09/tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96-amd64)
...
.. code-block::
   ...
   docker run -d --net=host -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96 \
          --env SOLUTIONDAG=solution_preprocessing_ml_agenticai_mqtt_dag-tml-multi-agenticai-iot-3f10 \
          ...
          reshmareddy09/tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96-amd64
...
[tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96] Github Repo
---------------
...
.. important::
   https://tml-multi-agenticai-iot-3f10-ml-agenticai-mqtt-4f96.readthedocs.io
...
.. important::
   solution_preprocessing_ml_agenticai_mqtt_dag-tml-multi-agenticai-iot-3f10
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.2, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=41677, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=35747, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=36427, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=45615, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=41509, HPDEHOST=172.17.0.2, HPDEPORT=35977, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=35059

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5825-tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96,solution_preprocessing_ml_agenticai_mqtt_dag-tml-multi-agenticai-iot-3f10, python-preprocess-137-tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96,solution_preprocessing_ml_agenticai_mqtt_dag-tml-multi-agenticai-iot-3f10, python-ml-6153-tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96,solution_preprocessing_ml_agenticai_mqtt_dag-tml-multi-agenticai-iot-3f10, python-predict-9179-tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96,solution_preprocessing_ml_agenticai_mqtt_dag-tml-multi-agenticai-iot-3f10, python-agenticai-1067-tml-multi-agenticai-iot-3f10-ml_agenticai_mqtt-4f96,solution_preprocessing_ml_agenticai_mqtt_dag-tml-multi-agenticai-iot-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
